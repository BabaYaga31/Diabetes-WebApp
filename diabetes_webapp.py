...
# user_input_scaled = sc.fit_transform(X_test)
...
y_prob = RandomForesClassifier.predict_proba(X_test)[:, 0:]
...
# Probability of prediction on test data
st.subheader('Prediction Probability on Test data')
st.write(y_prob)
